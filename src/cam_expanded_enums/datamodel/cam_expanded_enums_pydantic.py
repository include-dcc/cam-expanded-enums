...
linkml_meta = LinkMLMeta({'default_prefix': 'cam_expanded_enums',
     ...
     'prefixes': {'PATO': {'prefix_prefix': 'PATO',
                  ...
                  'cam_expanded_enums': {'prefix_prefix': 'cam_expanded_enums',
                                         'prefix_reference': 'https://w3id.org/include-dcc/cam-expanded-enums/'},
     ...
     'see_also': ['https://include-dcc.github.io/cam-expanded-enums'],
     'source_file': 'src/cam_expanded_enums/schema/cam_expanded_enums.yaml',
     'title': 'cam-expanded-enums'} )
...
class Person(NamedThing):
    ...
    Represents a Person
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/include-dcc/cam-expanded-enums',
